...
| --- | --- |
| [Osmo Pocket 3](../protocol/pocket3/) | Physical Mimo survey, connection and command evidence, implementation gaps |
| [Osmo Pocket 4 Pro](../protocol/pocket4-pro/) | Slow Motion, Photo, and Live Photo command evidence |
...
Existing Pocket reference URLs remain unchanged. New device references belong
in this section; common wire definitions stay in Shared protocol.
