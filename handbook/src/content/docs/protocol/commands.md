...
| `0x04/0x05` | **gimbal attitude** | unsolicited ~10 Hz, 50 B. i16-LE @4 in 0.1° yaw; i16-LE @2 in 0.1° pitch. Absolute yaw > 90° is the selfie-facing pose. Joystick pan and `FE 09` both move it. `@6` is not tilt (live Pocket 4 held 13.0…16.6° while `@2` hit −90° looking down) |
