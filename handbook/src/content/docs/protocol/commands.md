...
| `0x02/0xb8` | **zoom SET** | slider `0A 4E` + lens `@14` (217 = 1×, 651 = 3×, 2604 = 12× on Pocket 4 Pro). Chip cycle follows the body: 4 Pro 1×/3×/6×/12×; Pocket 4 / 3 1×/2×/4× (Pocket 3 4K Video max 2×, DJI spec); Nano 1×. SlowMo / TimeLapse / SuperNight: digital zoom off (Pro keeps 1×/3× optical). Mimo 1×→12× pinch is this form only, ~20 Hz. Older takes also have slew `03 00` + 100/300. ACK `00`. No GET |
