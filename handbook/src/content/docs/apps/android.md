...
Hold zoom for a continuous dial. The disc reads hundredths (1.53×) and ticks in
0.01 steps; the chip still shows tenths. In landscape the larger zoom disc extends to the trailing screen
