...
- Camera writes (record, ISO, EV, zoom, gimbal on Pocket). Zoom chips follow
  ...
  of degrees; a nod tilts until the pose matches, including while you are still
  turning (Fast + tilt unlocked at calibrate). Roll is shown, not driven. STOP clears the
