...
- Camera writes (record, ISO, EV, zoom, gimbal on Pocket). Zoom chips follow
  ...
  of degrees; a nod tilts until the live gimbal pose matches (the Pocket has no
  absolute angle SET — the stick closes onto that look). Fast + tilt unlocked at calibrate. Roll is shown, not driven. STOP clears the
