...
@Suite struct MimoControlTests {
    ...
    @Test func gimbalBuilders() {
        ...
        let trackRight = GimbalStick.encode(x: 1, y: 0, invertPan: true)
        #expect(trackRight.axis0 == GimbalStick.center && trackRight.axis1 == GimbalStick.min)
        let trackLeft = GimbalStick.encode(x: -1, y: 0, invertPan: true)
        #expect(trackLeft.axis0 == GimbalStick.center && trackLeft.axis1 == GimbalStick.max)
        let trackUp = GimbalStick.encode(x: 0, y: 1, invertPan: true)
        #expect(trackUp.axis0 == GimbalStick.max && trackUp.axis1 == GimbalStick.center)
