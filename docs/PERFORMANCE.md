...
| Watch preview | Ack-paced HEIC (JPEG fallback), drop-stale, max 3 in flight. Encode off the present thread. No extra `0x09/0xa8`. Adaptive 512 / 672 / 832 px from RTT. | `WatchRelay` |
