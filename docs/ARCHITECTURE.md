...
| **Android app** | `Apps/Android/app/` | Jetpack Compose phone shell. Live/pairing chrome uses Kyant liquid glass (`GlassChrome.kt`) with Pocket iOS tokens; HEVC live view stays a `SurfaceView` (Kyant cannot sample it). |
