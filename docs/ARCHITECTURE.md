...
| AirPods look-at gimbal | `HeadTrack` (Euler Δatt yaw/pitch from SET; throw until live `0x04/0x05` matches) | iOS `HeadphoneMotionBridge`. Roll readout only. Android: no IMU — PARITY exception. |
