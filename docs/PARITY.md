...
- Camera-value pickers (ISO, shutter/EV, exposure, WB, focus, audio) grow from
  ...
  Manual settling; physical Pocket lighting-change qualification remains pending
  on both platforms. FORMAT, COLOR and shooting mode hang from the top well of those
