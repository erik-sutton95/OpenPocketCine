...
Those pairs match accepted `0x02/0x18` writes in the [Pocket 3 survey](../handbook/src/content/docs/protocol/pocket3.md#shooting-modes-and-formats).
...
verification remain pending. See the [survey evidence](../handbook/src/content/docs/protocol/pocket3.md#openpocketcine-recording-and-warm-reconnect).
...
custom retention, direction, rotation and cached video playback. Physical
qualification remains pending on both platforms: no Android device is attached,
and the paired iPhone was unavailable as an Xcode test destination. These checks
do not establish camera-connected cadence or sustained thermal performance.
