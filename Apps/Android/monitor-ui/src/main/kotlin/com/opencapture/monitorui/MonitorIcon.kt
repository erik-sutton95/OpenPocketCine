...
enum class MonitorIcon(
    ...
    CARD_SIM("card-sim", R.drawable.opc_lucide_card_sim),
    ...
    REPEAT("repeat", R.drawable.opc_lucide_repeat),
    ...
    TRIANGLE_ALERT("triangle-alert", R.drawable.opc_lucide_triangle_alert),
