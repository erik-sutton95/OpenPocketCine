    ...
    public enum MonitorIcon: String, CaseIterable, View {
        case aperture
        ...
        public var lucideName: String { rawValue }

        public var body: some View {
            LucideIconView(name: rawValue)
        }

        public func view(filled: Bool = false) -> LucideIconView {
    ...
    public struct LucideIconView: View {
        ...
        public init(name: String, filled: Bool = false) {
            self.name = name
            self.filled = filled
        }
